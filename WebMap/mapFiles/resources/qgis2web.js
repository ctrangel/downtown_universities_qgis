...
map.getView().fit([-18411522.021909, 1876493.310776, -7114436.316078, 7516012.932297], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">U.S. Downtown Colleges and Universities</h2>';
        return titleElement;
    })(),
